...
@section('page_title', 'CLSU runner nabs four-medal haul in regâ€™l track meet after near withdrawal | CLSU Collegian')
...
@section('canonical_url', url('/article/clsu-runner-nabs-four-medal-haul-in-regl-track-meet-after-near-withdrawal?v=2'))
@section('og_title', 'CLSU runner nabs four-medal haul in regâ€™l track meet after near withdrawal | CLSU Collegian')
...
@section('twitter_title', 'CLSU runner nabs four-medal haul in regâ€™l track meet after near withdrawal | CLSU Collegian')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">CLSU runner nabs four-medal haul in regâ€™l track meet after near withdrawal</h1>
        ...
        <a href="{{ url('/article?slug=clsu-runner-nabs-four-medal-haul-in-regl-track-meet-after-near-withdrawal') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
