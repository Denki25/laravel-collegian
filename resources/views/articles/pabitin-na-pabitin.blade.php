...
@section('page_description', 'Yung nakapag-samgyup na mga tropa mo tapos ikaw nasa â€œthis form is no longer accepting responsesâ€ pa rinâ€¦ Aray ko.')
@section('canonical_url', url('/article/pabitin-na-pabitin?v=2'))
@section('og_title', 'Pabitin na Pabitin | CLSU Collegian')
@section('og_description', 'Yung nakapag-samgyup na mga tropa mo tapos ikaw nasa â€œthis form is no longer accepting responsesâ€ pa rinâ€¦ Aray ko.')
...
@section('twitter_description', 'Yung nakapag-samgyup na mga tropa mo tapos ikaw nasa â€œthis form is no longer accepting responsesâ€ pa rinâ€¦ Aray ko.')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <p style="font-size: 1.05rem; line-height: 1.6; color: #444; margin: 0 0 24px;">Yung nakapag-samgyup na mga tropa mo tapos ikaw nasa â€œthis form is no longer accepting responsesâ€ pa rinâ€¦ Aray ko.</p>
        ...
        <a href="{{ url('/article?slug=pabitin-na-pabitin') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
