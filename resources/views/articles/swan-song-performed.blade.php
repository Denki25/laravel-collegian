...
@section('page_description', '4 graduating CLSU student-artists triumph at reg’l arts events.')
@section('canonical_url', url('/share/swan-song-performed.html?v=2'))
@section('og_title', 'SWAN SONG PERFORMED! | CLSU Collegian')
@section('og_description', '4 graduating CLSU student-artists triumph at reg’l arts events.')
...
@section('twitter_description', '4 graduating CLSU student-artists triumph at reg’l arts events.')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <p style="font-size: 1.05rem; line-height: 1.6; color: #444; margin: 0 0 24px;">4 graduating CLSU student-artists triumph at reg’l arts events.</p>
        ...
        <a href="{{ url('/article.html?slug=swan-song-performed') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
