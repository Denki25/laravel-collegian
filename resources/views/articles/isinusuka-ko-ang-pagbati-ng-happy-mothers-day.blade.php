...
@section('page_title', 'Isinusuka ko ang Pagbati ng “Happy Mother’s Day | CLSU Collegian')
...
@section('canonical_url', url('/share/isinusuka-ko-ang-pagbati-ng-happy-mothers-day.html?v=2'))
@section('og_title', 'Isinusuka ko ang Pagbati ng “Happy Mother’s Day | CLSU Collegian')
...
@section('twitter_title', 'Isinusuka ko ang Pagbati ng “Happy Mother’s Day | CLSU Collegian')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">Isinusuka ko ang Pagbati ng “Happy Mother’s Day</h1>
        ...
        <img src="{{ asset('PHOTOS/LITERARY/lit6.jpg') }}" alt="Isinusuka ko ang Pagbati ng “Happy Mother’s Day” artwork" style="width: 100%; height: auto; border-radius: 16px; display: block; margin-bottom: 20px;">
        <p style="font-size: .95rem; color: #666; margin: 0 0 16px;">This preview page is safe to share on Facebook and X/Twitter.</p>
        <a href="{{ url('/article.html?slug=isinusuka-ko-ang-pagbati-ng-happy-mothers-day') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
