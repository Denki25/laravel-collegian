...
@section('page_title', 'Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version) | CLSU Collegian')
...
@section('canonical_url', url('/article/limang-hakbang-sa-likod-ng-parangal-at-papuri-peters-version?v=2'))
@section('og_title', 'Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version) | CLSU Collegian')
...
@section('og_image_alt', 'Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version)')
@section('twitter_title', 'Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version) | CLSU Collegian')
...
@section('twitter_image_alt', 'Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version)')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version)</h1>
        ...
        <img src="{{ asset('PHOTOS/FEATURES/feature4.jpg') }}" alt="Limang Hakbang sa Likod ng Parangal at Papuri (Peterâ€™s Version)" style="width: 100%; height: auto; border-radius: 16px; display: block; margin-bottom: 20px;">
        <p style="font-size: .95rem; color: #666; margin: 0 0 16px;">This preview page is safe to share on Facebook and X/Twitter.</p>
        <a href="{{ url('/article?slug=limang-hakbang-sa-likod-ng-parangal-at-papuri-peters-version') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
