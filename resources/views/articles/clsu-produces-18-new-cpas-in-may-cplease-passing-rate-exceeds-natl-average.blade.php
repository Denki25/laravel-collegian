...
@section('page_title', 'CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average | CLSU Collegian')
...
@section('canonical_url', url('/share/clsu-produces-18-new-cpas-in-may-cplease-passing-rate-exceeds-natl-average.html?v=2'))
@section('og_title', 'CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average | CLSU Collegian')
...
@section('og_image_alt', 'CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average')
@section('twitter_title', 'CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average | CLSU Collegian')
...
@section('twitter_image_alt', 'CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average</h1>
        ...
        <img src="{{ asset('PHOTOS/NEWS/news8.jpg') }}" alt="CLSU produces 18 new CPAs in May CPALE, passing rate exceeds nat’l average" style="width: 100%; height: auto; border-radius: 16px; display: block; margin-bottom: 20px;">
        <p style="font-size: .95rem; color: #666; margin: 0 0 16px;">This preview page is safe to share on Facebook and X/Twitter.</p>
        <a href="{{ url('/article.html?slug=clsu-produces-18-new-cpas-in-may-cplease-passing-rate-exceeds-natl-average') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
