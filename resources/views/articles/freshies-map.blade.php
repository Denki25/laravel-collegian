...
@section('page_title', 'Places That Feel Like Home: A Freshie’s Map to CLSU | CLSU Collegian')
...
@section('canonical_url', url('/share/freshies-map.html?v=2'))
@section('og_title', 'Places That Feel Like Home: A Freshie’s Map to CLSU | CLSU Collegian')
...
@section('twitter_title', 'Places That Feel Like Home: A Freshie’s Map to CLSU | CLSU Collegian')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">Places That Feel Like Home: A Freshie’s Map to CLSU</h1>
        ...
        <a href="{{ url('/article.html?slug=freshies-map') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
