...
@section('page_title', 'CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander | CLSU Collegian')
...
@section('canonical_url', url('/share/clsu-rotc-earns-excellent-mark-in-raati-under-first-female-corps-commander.html?v=2'))
@section('og_title', 'CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander | CLSU Collegian')
...
@section('og_image_alt', 'CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander')
@section('twitter_title', 'CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander | CLSU Collegian')
...
@section('twitter_image_alt', 'CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander</h1>
        ...
        <img src="{{ asset('PHOTOS/NEWS/news3.jpg') }}" alt="CLSU-ROTC earns ‘excellent’ mark in RAATI under first female corps commander" style="width: 100%; height: auto; border-radius: 16px; display: block; margin-bottom: 20px;">
        <p style="font-size: .95rem; color: #666; margin: 0 0 16px;">This preview page is safe to share on Facebook and X/Twitter.</p>
        <a href="{{ url('/article.html?slug=clsu-rotc-earns-excellent-mark-in-raati-under-first-female-corps-commander') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
