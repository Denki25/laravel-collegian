...
@section('page_title', '3 CLSU Educ grads top 2026 LEPT; both levels surpass natâ€™l passing | CLSU Collegian')
...
@section('canonical_url', url('/article/3-clsu-educ-grads-top-2026-lept-both-levels-surpass-natl-passing?v=2'))
@section('og_title', '3 CLSU Educ grads top 2026 LEPT; both levels surpass natâ€™l passing | CLSU Collegian')
...
@section('twitter_title', '3 CLSU Educ grads top 2026 LEPT; both levels surpass natâ€™l passing | CLSU Collegian')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">3 CLSU Educ grads top 2026 LEPT; both levels surpass natâ€™l passing</h1>
        ...
        <a href="{{ url('/article?slug=3-clsu-educ-grads-top-2026-lept-both-levels-surpass-natl-passing') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
