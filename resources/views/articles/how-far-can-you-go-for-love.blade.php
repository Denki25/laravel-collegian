...
@section('twitter_title', 'How far can you go for love? | CLSU Collegian')
...
@section('twitter_image', asset('PHOTOS/LITERARY/lit8.jpg'))
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">How far can you go for love?</h1>
