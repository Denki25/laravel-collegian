...
@section('og_image_alt', 'Hindi Tayo sa Papel')
@section('twitter_title', 'Hindi Tayo sa Papel | CLSU Collegian')
...
@section('twitter_image', asset('PHOTOS/LITERARY/lit10.jpg'))
@section('twitter_image_alt', 'Hindi Tayo sa Papel')
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <h1 style="font-size: 2rem; line-height: 1.15; margin: 0 0 12px;">Hindi Tayo sa Papel</h1>
