...
@section('canonical_url', url('/share/psa-da-urged-to-reconcile-data-on-local-onion-production.html?v=2'))
...
@section('content')
    <main style="max-width: 720px; margin: 48px auto; font-family: Arial, sans-serif; padding: 0 20px;">
        ...
        <p style="font-size: 1.05rem; line-height: 1.6; color: #444; margin: 0 0 24px;">Committee on Agriculture, Food, and Agrarian Reform Chairman Sen. Francis “Kiko” Pangilinan called for an urgent harmonization of local onion production data, following discrepancies between the report of Philippine Statistics Authority (PSA) and Department of Agriculture (DA), during the Senate Hearing held at DA – Philippine Carabao Center National Headquarters and Genepool, March 26.</p>
        ...
        <a href="{{ url('/article.html?slug=psa-da-urged-to-reconcile-data-on-local-onion-production') }}" style="display: inline-block; background: #fe5d13; color: #fff; text-decoration: none; padding: 12px 18px; border-radius: 999px; font-weight: 700;">Read full article</a>
    </main>
@endsection
